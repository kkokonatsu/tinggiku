...
# Path absolut ke folder 'models/checkpoints' relatif terhadap file ini
current_dir = os.path.dirname(os.path.abspath(__file__))
checkpoint_path = os.path.abspath(os.path.join(current_dir, '..', '..', '..', '..', 'models', 'checkpoints', 'depth_pro.pt'))
